            ...
            <div class="pro-teams">
                <div class="pro-team-lead">
                    ...
                    <div class="avatar-group">
                        <div class="avatar">
                            <img class="avatar-img rounded-circle border border-white" alt="User Image" src="/img/avatar.jpg">
                        </div>
                        <div class="avatar">
                            <img class="avatar-img rounded-circle border border-white" alt="User Image" src="/img/avatar.jpg">
                        </div>
                            ...
                            <div class="kanban-box">
                                ...
                                <div class="task-board-body">
                                    ...
                                    <div class="kanban-footer">
                                        ...
                                        <img src="/img/avatar.jpg" class="task-avatar" width="24" height="24" alt="">
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <a href="#">
                                <div class="media d-flex">
                                    <span class="avatar flex-shrink-0"><img alt="" src="/img/avatar.jpg"></span>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="task-follower-list">
                            ...
                            <img src="/img/avatar.jpg" class="avatar" alt="John Doe" width="20" height="20">
                            <i class="fa fa-times"></i>
                            </span>
                            <span data-bs-toggle="tooltip" title="Richard Miles">
                            <img src="/img/avatar.jpg" class="avatar" alt="Richard Miles" width="20" height="20">
                            <i class="fa fa-times"></i>
                            </span>
                            <span data-bs-toggle="tooltip" title="John Smith">
                            <img src="/img/avatar.jpg" class="avatar" alt="John Smith" width="20" height="20">
                            <i class="fa fa-times"></i>
                            </span>
                            <span data-bs-toggle="tooltip" title="Mike Litorus">
                            <img src="/img/avatar.jpg" class="avatar" alt="Mike Litorus" width="20" height="20">
                            <i class="fa fa-times"></i>
                            </span>
                        </div>
                    </div>
