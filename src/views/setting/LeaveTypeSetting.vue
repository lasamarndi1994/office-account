        ...
        <div class="table-responsive">
          ...
          >
            ...
            <div class="row">
              <div class="col-sm-12">
                <table
                  class="table table-striped custom-table datatable mb-0 dataTable no-footer"
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th
                        ...
                        rowspan="1"
                        colspan="1"
                        aria-label="Leave Days: activate to sort column ascending"
                        style="width: 181.01px"
                      >
                        Leave Days
                      </th>
                      <th
