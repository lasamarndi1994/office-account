                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="select select2-hidden-accessible" data-select2-id="select2-data-1-ov6i" tabindex="-1" aria-hidden="true">
                                <option data-select2-id="select2-data-3-njyq">None</option>
                                <option>SSL</option>
                                <option>TLS</option>
                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-1mop" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-o3ta-container" aria-controls="select2-o3ta-container"><span class="select2-selection__rendered" id="select2-o3ta-container" role="textbox" aria-readonly="true" title="None">None</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
