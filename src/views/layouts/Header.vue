<template>
  <div class="header">
    ...
    <a id="toggle_btn" @click="toogleBar()" href="javascript:void(0);">
      <span class="bar-icon">
        <span></span>
        <span></span>
        <span></span>
    ...
    <ul class="nav user-menu">
      ...
      <li class="nav-item dropdown">
        <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
          <i class="fas fa-bell"></i> <span class="badge rounded-pill">3</span>
        </a>
...
export default {
  ...
  methods: {
    toogleBar() {
      ...
      var subdrop = document.querySelector(".router-link-active");
      element.classList.toggle("mini-sidebar");
    },
    toogleBarMob() {
      var mobelement = document.querySelector(".main-wrapper");
      mobelement.classList.toggle("slide-nav");
    },
	logout(){
		localStorage.clear();
